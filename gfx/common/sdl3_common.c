...
/* Shared between the sdl3 video driver and the SDL3 GL/Vulkan gfx
 * context drivers - they all consume window lifecycle events the same
 * way while the SDL3 input driver drains the input events. */
